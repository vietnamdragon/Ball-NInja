...
public class Constants {
	...
	//control left right lase
	public static final String BTN_LEFT = "arrowLeft";
	public static final String BTN_RIGHT = "arrowRight";
	public static final String BTN_POWER_BLUE = "laserBlue08";
